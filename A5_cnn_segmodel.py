...
def load_data_from_pairs(label_training_pairs, count = None):
...
X_train, y_train = load_data_from_pairs(train_dataset, count=5000)
X_val, y_val = load_data_from_pairs(val_dataset, count=5000)
